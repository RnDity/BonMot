...
public class TextAlignmentConstraint: NSLayoutConstraint {
    ...
    @IBInspectable public var firstAlignment: String? {
        didSet {
            firstItemAttribute = BonMot.TextAlignmentConstraint.BonAttribute(ibInspectableString: firstAlignment?.normalized ?? "")
        }
    }

    @IBInspectable public var secondAlignment: String? {
        didSet {
            secondItemAttribute = BonMot.TextAlignmentConstraint.BonAttribute(ibInspectableString: secondAlignment?.normalized ?? "")
        }
    }

    public private(set) var firstItemAttribute: BonMot.TextAlignmentConstraint.BonAttribute = .unspecified
    public private(set) var secondItemAttribute: BonMot.TextAlignmentConstraint.BonAttribute = .unspecified
    ...
    public static func with(item view1: AnyObject, attribute attr1: BonMot.TextAlignmentConstraint.BonAttribute, relatedBy relation: NSLayoutRelation, toItem view2: AnyObject, attribute attr2: BonMot.TextAlignmentConstraint.BonAttribute) -> TextAlignmentConstraint {
    ...
    private func distanceFromTop(of item: AnyObject, with attribute: BonMot.TextAlignmentConstraint.BonAttribute) -> CGFloat {
